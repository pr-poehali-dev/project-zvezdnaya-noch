const contractPoints = [
  {
    ...
    value: "За день до экскурсии",
  },
  {
    point: "Пункт 1.5.3",
    label: "Срок изменения или аннулирования заказа",
    value: "Не позднее, чем за (дата за день до экскурсии)",
  },
  {
    point: "Пункт 1.5.3",
    label: "Право заказчика на изменение",
    value: "Заказчик имеет право изменить не позднее чем (дата за день до начала экскурсии)",
  },
  {
    point: "Пункт 2.2.6",
    label: "Срок ответа на изменения",
    value: "В течение 7 (семи) рабочих дней",
  },
  {
    point: "Пункт 3.2.1",
    label: "Срок полной оплаты",
    value: "Не менее чем за сутки до начала оказания услуг",
  },
  {
    point: "Пункт 3.2.2",
    label: "Размер и срок предоплаты",
    value: "Заказчик производит предварительную оплату услуг в размере 10%, в срок до 25 июля (если экскурсия раньше 25 июля 2026 г., дата меняется на более раннюю)",
  },
  {
    point: "Пункт 6.5",
